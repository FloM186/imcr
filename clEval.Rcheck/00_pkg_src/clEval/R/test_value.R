...
#'
#' @return The test value table (in console and html format displayed in Viewer tab in Rstudio) and a plot with means, standard deviation and test value for each variable and for each cluster
#' @export
